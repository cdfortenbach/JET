...
* The JET code was written in Python 3.6.2.  It is highly recommended that you use Python 3.6.2 to run JET.
...
| JET_Master.56.sh            | Linux shell script controlling the JET code                                              |
...
| Pdxo_Master.68.py           | Python program (element of JET)                                                          |
...
for JET: 
Fortenbach, Charles D., and Courtney D. Dressing. "A Framework for Optimizing Exoplanet Target Selection for the James Webb Space Telescope." Publications of the Astronomical Society of the Pacific 132, no. 1011 (2020): 054501.
(https://dx.doi.org/10.1088/1538-3873/ab70da)
...
* 1.2.1 (2020-03-23)
    Specified python 3.6.2 rather than 3.6.1/2
    Added citation details for publication in PASP, 2020-03-18
    Corrected GitHub repository: replaced missing opacity file (opacCIA.dat) in Opac folder
