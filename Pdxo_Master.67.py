    ...
    if Rp < 10:
        ...
        if Jmag > Jmag_sat:
            ...
            for j in range(0, 2): 
                ...
                Science_time = tdur_sec \
                             + (Out_trans_factor/100)*tdur_sec \
                             + Timing_tax                                # sec
                ...
                for idx, ntr in enumerate(ints):
                    ...
                    for nrun in range(0, Npdxo): 
                        ...
                        reduced_chi_squared = chi_squared/(len(x1)-nparams)
                        ...
                        BICMS = chi_squared + nparams*np.log(len(x1))
                        ...
                        BICFL = chi_squared + nparams*np.log(len(x1))
